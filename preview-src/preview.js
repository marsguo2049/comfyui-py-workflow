...
$('#batch-message').textContent = '示例任务待开始。实际处理请在本机运行 ComfyUI Workbench。';
...
document.querySelectorAll('button:disabled, input:disabled, textarea:disabled, select:disabled').forEach(node => node.title = '仅展示。实际处理请在本机运行 ComfyUI Workbench。');
